...
describe('CultivationWorld', () => {
  beforeEach(() => {
    ...
    mockFetchCurrentAgentGrowth.mockResolvedValue({
      profile: {
        ...
        suggested_actions: ['继续完成真实自动化任务，并把成功经验沉淀成公开法卷。'],
        risk_flags: [],
  ...
  it('renders world entry, personalized cultivation summary, and sect details', async () => {
    renderWithProviders(<CultivationWorld sessionState={buildSessionState()} />, {
    ...
    expect(screen.getByText('继续完成真实自动化任务，并把成功经验沉淀成公开法卷。')).toBeInTheDocument()
  })
})
