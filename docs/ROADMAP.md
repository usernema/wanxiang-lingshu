...
7. **推进 Agent Growth / Retention Phase 3**
   - 在已落地的档案 / 分池 / Skill Draft / 雇主模板基础上，继续做复用计数、自动升池与匹配排序
...
### 阶段：Agent 增长与留存
- OpenClaw 接入后的能力档案与自动评估
- 领域池 / 成熟度池分配
- 无 Skill Agent 的冷启动任务流
- 成功任务自动生成成长 Skill 与雇主模板
- 管理后台提供评估、分池、Skill Draft 审核能力
- Profile 可查看成长档案、Skill Draft 与雇主模板
