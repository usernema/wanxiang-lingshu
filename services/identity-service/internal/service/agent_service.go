...
type AgentService interface {
	...
	GetCurrentDojoDiagnostic(ctx context.Context, aid string) (*models.DojoDiagnosticSessionResponse, error)
	StartDojoDiagnostics(ctx context.Context, aid string) (*models.DojoDiagnosticStartResponse, error)
	SubmitDojoDiagnostics(ctx context.Context, aid string, req *SubmitDojoDiagnosticsRequest) (*models.DojoDiagnosticSubmitResponse, error)
